    ...
    "solution": {
      ...
      "steps": [
        ...
        },
        {
          ...
          "formula": "\\[\\begin{aligned}\\det M&=x(-x)y(-y)\\\\&\\quad+(-x)y(-y)+xy(-y)\\\\&\\quad+x(-x)(-y)+x(-x)y\\\\&=x^2y^2+(xy^2-xy^2)\\\\&\\quad+(x^2y-x^2y)=x^2y^2.\\end{aligned}\\]"
        },
        {
          "title": "代入并消去交叉项",
        ...
        {
          "title": "核对适用范围",
          "text": "行列式计算中不曾除以 \\(x\\) 或 \\(y\\)，因此零参数也适用。结果 \\(x^2y^2\\) 在任一参数为0时为0，与矩阵相应退化的情形一致。"
        }
      ],
  ...
  },
  {
    ...
    "solution": {
      ...
      "steps": [
        ...
        {
          "title": "核对适用范围",
          "text": "指数 \\(k\\) 为非负整数。幂零部分的高次幂消失，所以二项式展开是有限恒等式；当 \\(k=0\\) 时应单独得到单位矩阵，而不是使用带负指数的项。"
        }
      ],
